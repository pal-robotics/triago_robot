...
def declare_actions(launch_description: LaunchDescription, launch_args: LaunchArguments):
    ...
    # Add controller of head gripper
    launch_description.add_action(OpaqueFunction(
        function=set_side_gripper, args=['head'],
        condition=IfCondition(
            PythonExpression(
                ["'", LaunchConfiguration('end_effector_head'), "' == 'pal-pro-gripper' and '",
                 LaunchConfiguration('arm_type_head'), "' != 'no-arm'"]
            )
        )))
